...
import com.ldgen.ldgenaimaster.core.AiCodeGeneratorFacade;
...
import com.ldgen.ldgenaimaster.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        ThrowUtils.throwIf(app == null, ErrorCode.NOT_FOUND_ERROR, "请求应用不存在");
        //3.验证用户是否有权限访问引用，仅本人可以生成代码
        ...
        if (codeGenTypeEnum == null) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "不支持代码生成类型");
        }
        //5.调用Ai 生成代码
